  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Registration Slice",
        icon: <FiEdit />,
        permission: "create_registration_slice",
      },
      {
        id: "settings",
        label: "Settings",
